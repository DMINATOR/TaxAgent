...
public class Engine 
{
	...
	public static JSONObject AgentRequestProgramLowerPrice(int yearID, int taxPayerID, int taxProgramID, double proposedPrice) throws JSONException 
	{
		JSONObject object = new JSONObject();
		...
		object.put("TaxPayerID", taxPayerID );
		object.put("ProgramID", taxProgramID );
		object.put("ProposedPrice", proposedPrice );
		
		return createBase("TaxPayer.Agent.RequestProgramLowerPrice" , object);
	}
	
	
	public static JSONObject ApproveProgramPrice(int yearID, int taxPayerID, int taxProgramID, double proposedPrice) throws JSONException 
	{
		JSONObject object = new JSONObject();
		...
		return createBase("TaxPayer.Agent.ApproveProgramPrice" , object);
	}
}
